  ...
  // ── BASICS ────────────────────────────────────────────────────────────────
  {
    ...
    sections:[
      { h:HL('¿Qué es KAI Owners App?','What is KAI Owners App?'),
        b:HL('KAI Owners App es la plataforma privada de los propietarios del edificio KAI. Centraliza el registro de unidades, el reporte de incidentes (con fotos), incidentes generales de la comunidad, notificaciones automáticas y comunicación entre propietarios y administración.','KAI Owners App is the private platform for KAI building owners. It centralizes unit registration, incident reporting (with photos), community-wide general incidents, automatic notifications, and communication between owners and management.')},
  ...
  },
  {
    ...
    sections:[
      ...
      { h:HL('Acciones del administrador','Administrator actions'),
        b:HL('Solo los administradores globales y delegados con permiso "Cerrar incidentes" pueden actuar: 🏠 "Asignar a unidad" — elige la unidad responsable y el incidente entra al flujo normal (el propietario recibirá el Paso 1 y Paso 2); ✓ "Cerrar directamente" — el admin documenta la acción tomada y la resolución sin asignar a ninguna unidad.','Only global admins and delegates with "Close incidents" permission can act: 🏠 "Assign to unit" — choose the responsible unit and the incident enters the normal flow (owner gets Step 1 and Step 2); ✓ "Close directly" — admin documents the action and resolution without assigning to any unit.')},
    ]
  },
  {
  ...
  // ── NOTIFICATIONS ─────────────────────────────────────────────────────────
  {
    ...
    sections:[
      ...
      { h:HL('Notificaciones por email','Email notifications'),
        b:HL('Cada evento genera un email automático a todos los involucrados: propietario, operador, quien reportó, administrador global y administradores delegados autorizados. El routing de emails es configurable desde Admin → Enrutamiento de emails.','Each event generates an automatic email to everyone involved: owner, operator, reporter, global admin, and authorized delegate admins. Email routing is configurable from Admin → Email Routing.')},
    ]
  },
  // ── DASHBOARD ─────────────────────────────────────────────────────────────
  {
  ...
  // ── SLA ───────────────────────────────────────────────────────────────────
  {
    ...
    sections:[
      ...
      { h:HL('Recordatorios a propietario, operador y admins','Reminders to owner, operator, and admins'),
        b:HL('Cuando el SLA vence, el sistema notifica automáticamente al propietario, operador, administrador global y delegados autorizados. Todos reciben el contexto del incidente y el paso pendiente. El routing es configurable desde Admin → Enrutamiento de emails.','When SLA expires, the system automatically notifies the owner, operator, global admin, and authorized delegates. All receive the incident context and the pending step. Routing is configurable from Admin → Email Routing.')},
  ...
  // ── ADMIN ─────────────────────────────────────────────────────────────────
  {
    ...
    sections:[
      ...
      { h:HL('Enrutamiento de emails','Email routing'),
        b:HL('En Admin → Enrutamiento de emails puedes activar/desactivar cada tipo de email y elegir quién lo recibe (propietario, operador, quien reportó, admin global, admin delegado). Por defecto todos los tipos notifican al admin global y admin delegado. Los cambios aplican de inmediato.','In Admin → Email Routing you can enable/disable each email type and choose who receives it (owner, operator, reporter, global admin, delegate admin). By default all types notify the global and delegate admins. Changes apply immediately.')},
    ]
  },
  {
