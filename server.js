...
"incident_resolved": {"label": "Incidente resuelto", "subject": "✅ Incidente resuelto - Apto {{apt}} Torre KAI", "text": "Hola{{reporterName ? ', '+reporterName : ''}},\n\n✅ El incidente en el Apto {{apt}} ha sido resuelto.\n\n{{reporterName ? 'Gracias por reportar este incidente. Tu reporte contribuyó a un resultado positivo para la comunidad.' : ''}}\n\nApartamento: {{apt}}\nPropietario: {{owner}}\nOperador: {{operator}}\nResuelto por: {{resolvedBy}}\nComentarios de resolución: {{resolutionComments}}\n\nVer incidente: {{incidentLink}}\n", "html": "<div style=\"font-family:Arial,sans-serif;line-height:1.5;color:#17313a;max-width:600px\"><div style=\"background:#e8f5ec;border:2px solid #2F4F3A;border-radius:12px;padding:16px;margin-bottom:20px\"><p style=\"margin:0;font-size:1.1em;font-weight:bold;color:#2F4F3A\">✅ Incidente resuelto — Apto {{apt}}</p></div>{{reporterName ? '<div style=\"background:#f0fdf4;border-left:4px solid #1eaa64;border-radius:8px;padding:12px 16px;margin-bottom:16px\"><p style=\"margin:0;color:#166534;font-weight:600\">🙏 Gracias, {{reporterName}}</p><p style=\"margin:6px 0 0;color:#166534;font-size:.9em\">Tu reporte contribuyó a un resultado positivo para la comunidad.</p></div>' : ''}}<p><strong>Apartamento:</strong> {{apt}} · Torre KAI<br/><strong>Propietario:</strong> {{owner}}<br/><strong>Operador:</strong> {{operator}}<br/><strong>Resuelto por:</strong> {{resolvedBy}}</p><p><strong>Comentarios de resolución:</strong></p><p style=\"background:#f6f1e7;border-left:4px solid #2F4F3A;padding:12px\">{{resolutionComments}}</p><p style=\"margin:18px 0\"><a href=\"{{incidentLink}}\" style=\"background:#2F4F3A;color:#fff;text-decoration:none;padding:10px 16px;border-radius:10px;display:inline-block;font-weight:700\">Ver incidente</a></p></div>"}};
...
"incident_resolved": {"label": "Incident resolved", "subject": "✅ Incident resolved - Apt {{apt}} Tower KAI", "text": "Hello{{reporterName ? ', '+reporterName : ''}},\n\n✅ The incident in Apt {{apt}} has been resolved.\n\n{{reporterName ? 'Thank you for reporting this incident. Your report contributed to a positive outcome for the community.' : ''}}\n\nApartment: {{apt}}\nOwner: {{owner}}\nOperator: {{operator}}\nResolved by: {{resolvedBy}}\nResolution comments: {{resolutionComments}}\n\nView incident: {{incidentLink}}\n", "html": "<div style=\"font-family:Arial,sans-serif;line-height:1.5;color:#17313a;max-width:600px\"><div style=\"background:#e8f5ec;border:2px solid #2F4F3A;border-radius:12px;padding:16px;margin-bottom:20px\"><p style=\"margin:0;font-size:1.1em;font-weight:bold;color:#2F4F3A\">✅ Incident resolved — Apt {{apt}}</p></div>{{reporterName ? '<div style=\"background:#f0fdf4;border-left:4px solid #1eaa64;border-radius:8px;padding:12px 16px;margin-bottom:16px\"><p style=\"margin:0;color:#166534;font-weight:600\">🙏 Thank you, {{reporterName}}</p><p style=\"margin:6px 0 0;color:#166534;font-size:.9em\">Your report contributed to a positive outcome for the community.</p></div>' : ''}}<p><strong>Apartment:</strong> {{apt}} · Tower KAI<br/><strong>Owner:</strong> {{owner}}<br/><strong>Operator:</strong> {{operator}}<br/><strong>Resolved by:</strong> {{resolvedBy}}</p><p><strong>Resolution comments:</strong></p><p style=\"background:#f6f1e7;border-left:4px solid #2F4F3A;padding:12px\">{{resolutionComments}}</p><p style=\"margin:18px 0\"><a href=\"{{incidentLink}}\" style=\"background:#2F4F3A;color:#fff;text-decoration:none;padding:10px 16px;border-radius:10px;display:inline-block;font-weight:700\">View incident</a></p></div>"}};
